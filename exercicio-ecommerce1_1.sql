...
insert into product (Pname, Classification, Category, Avaliação, size) values
...
insert into orders (idOrderClient, orderStatus, orderDescription, sendValue, paymentCah) values 
